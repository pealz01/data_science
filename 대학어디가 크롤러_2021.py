...
if __name__=='__main__':
    ...
    col_nm=['대학명','모집단위','모집시기','전형유형','전형명','모집인원','전년모집인원','전년경쟁률',
            '학생부_환산70%컷','학생부_등급50%컷','학생부_등급70%컷',
            '수능_환산70%컷','수능_등급70%컷','수능_국백70%컷','수능_수백70%컷','수능_탐백70%컷','수능_평백70%컷','추가안내사항']
    ...
    #저장할 위치 확인
    writer = pd.ExcelWriter('C:/Users/user/Desktop/2021_대학알리미_입결.xlsx')
